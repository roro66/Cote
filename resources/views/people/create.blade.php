<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class="h4">Crear Nueva Persona</h3>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('rut') is-invalid @enderror" 
                                           id="rut" name="rut" value="{{ old('rut') }}" placeholder="12.345.678-9" required>
                                    @error('rut')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('role_type') is-invalid @enderror" id="role_type" name="role_type" required>
                                        ...
                                        <option value="tesorero" {{ old('role_type') == 'tesorero' ? 'selected' : '' }}>Tesorero</option>
                                        <option value="trabajador" {{ old('role_type') == 'trabajador' ? 'selected' : '' }}>Trabajador</option>
                                    </select>
                                    @error('role_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('account_type') is-invalid @enderror" id="account_type" name="account_type">
                                        ...
                                        <option value="corriente" {{ old('account_type') == 'corriente' ? 'selected' : '' }}>Cuenta Corriente</option>
                                        <option value="vista" {{ old('account_type') == 'vista' ? 'selected' : '' }}>Cuenta Vista</option>
                                        <option value="ahorro" {{ old('account_type') == 'ahorro' ? 'selected' : '' }}>Cuenta de Ahorro</option>
                                    </select>
                                    @error('account_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_enabled" 
                                               name="is_enabled" {{ old('is_enabled', true) ? 'checked' : '' }}>
    ...
    $(document).ready(function() {
        ...
        // Manejar envío del formulario para mostrar mensajes de éxito/error
        $('#personForm').on('submit', function(e) {
            @if($errors->any() || session('error'))
                // Si hay errores, no hacer AJAX, dejar que se procese normalmente
                return true;
            @endif
        });
    });
